...
<head>
    ...
    <title>Admin Login | Aunty Anne's International School</title>
    ...
    <div class="container min-h-screen d-flex align-items-center justify-content-center">
        <div class="auth-container">
            <div class="content-section">
                ...
                <h2>Admin Login</h2>
                <p>Access your Aunty Anne’s International School admin portal.</p>
                <a href="{{ route('login') }}" class="cta-btn">Login as Student/Staff</a>
            </div>
            <div class="login-section">
                ...
                @endif
                <form method="POST" action="{{ route('admin.login') }}" x-data="{ submitting: false }"
                    ...
                    <div class="form-group">
                        <input type="text" id="username" name="username" class="form-input" placeholder="Username"
                            value="{{ old('username') }}" required aria-describedby="usernameValidation">
            ...
            if (usernameInput) {
                usernameInput.addEventListener('input', function () {
                    ...
                    if (!this.value) {
                        ...
                        validation.textContent = '✓ Valid username';
                    } else {
