...
<head>
    ...
    <title>Student/Staff Login | Aunty Anne's International School</title>
...
<body>
    <div class="container min-h-screen d-flex align-items-center justify-content-center">
        <div class="auth-container">
            <div class="content-section">
                ...
                <p>Securely Access Your Portal.</p>
            ...
            <div class="login-section">
                <div class="logo-section">
                    ...
                    <p class="subtitle">Securely Access Your Portal</p>
                </div>
                @if (session('status'))
                ...
                <form method="POST" action="{{ route('login') }}" x-data="{ submitting: false }"
                    ...
                    <div class="form-group">
                        <input type="text" id="identifier" name="identifier" class="form-input"
                            placeholder="Student ID (e.g., AAIS/0559/001) or Username" value="{{ old('identifier') }}"
                            required aria-describedby="identifierValidation">
                        <label for="identifier" class="form-label">Student ID or Username</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Password Visibility Toggle (only for password field)
            ...
            if (identifierInput) {
                identifierInput.addEventListener('input', function () {
                    ...
                    } else if (studentIdRegex.test(value) || value.length >= 3) {
                        this.classList.add('success');
                        this.classList.remove('error');
                        validation.textContent = '✓ Valid Student ID or Username';
                    } else {
                        this.classList.add('error');
                        this.classList.remove('success');
                        validation.textContent = 'Invalid Student ID (use AAIS/0559/XXX) or Username (min 3 chars)';
                    }
                });
            }
