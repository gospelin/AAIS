            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <blockquote class="testimonial text-center">
                        <p class="px-3">{{ config('app.name') }} has provided me with a nurturing environment to grow both
                            academically
                            and personally. The school's dedication and innovative approach to education have truly set me
                            on a path to success.</p>
                        <footer class="mt-3">- Mrs. Anyanwu, Alumni</footer>
                    </blockquote>
                </div>
                <div class="carousel-item">
                    <blockquote class="testimonial text-center">
                        <p class="px-3">As a parent, I am extremely pleased with the holistic education my child is
                            receiving at
                        ...
                        <footer class="mt-3">- Mr. Ezechukwu Chukwudi, Parent</footer>
                    </blockquote>
                </div>
                <div class="carousel-item">
                    <blockquote class="testimonial text-center">
                        <p class="px-3">The teachers at {{ config('app.name') }} are incredibly supportive and dedicated.
                            They go above
                            and beyond to ensure each student understands the material and feels confident in their
                            abilities.</p>
                        <footer class="mt-3">- Victoria Uwadiegwu, Current Student</footer>
                    </blockquote>
                </div>
                <div class="carousel-item">
                    <blockquote class="testimonial text-center">
                        <p class="px-3">I have seen my child's academic performance and social skills improve significantly
                            since joining
                            {{ config('app.name') }}. The school's focus on a well-rounded education is truly commendable.
                        </p>
                        <footer class="mt-3">- Beckley Gideon, Parent</footer>
                    </blockquote>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-12 col-md-6 gsap-fade-up">
                    ...
                    <p class="lead text-center">Step-by-step guidance on how to enroll your child, including forms and
                        deadlines.</p>
                    <div class="text-center">
                ...
                <div class="col-12 col-md-6 gsap-fade-up">
                    ...
                    <p class="lead text-center">Download our handbook for policies, schedules, and tips to support your
                        child’s journey.</p>
                    <div class="text-center">
