...
@section('content')
    <div class="hero" id="home">
        ...
        <div class="floating-elements">
            <div class="floating-element" style="width: 100px; height: 100px; left: 10%; animation-delay: 0s;"
                data-parallax-speed="0.3"></div>
            <div class="floating-element" style="width: 150px; height: 150px; left: 70%; animation-delay: -5s;"
                data-parallax-speed="0.5"></div>
            <div class="floating-element" style="width: 80px; height: 80px; left: 40%; animation-delay: -10s;"
                data-parallax-speed="0.2"></div>
            <div class="floating-element" style="width: 120px; height: 120px; left: 85%; animation-delay: -15s;"
                data-parallax-speed="0.4"></div>
        </div>
        <div class="hero-content container">
                <h1 class="hero-title display-3 gsap-fade-down" id="heroTitle" >{{ config('app.name') }}</h1>
                <h2 class="hero-subtitle lead my-4 gsap-fade-up">Empowering Young Minds Through Practical Learning</h2>
                <p class="hero-subtitle gsap-fade-up">We craft transformative educational journeys, blending hands-on skills with
                    unwavering confidence to shape tomorrow’s leaders.</p>
                <div class="hero-buttons">
                    <a href="#programs" class="btn-primary">Explore Programs</a>
                    <a href="#admissions" class="btn-secondary">Apply Now</a>
                </div>
        </div>
    </div>
    ...
    <section id="about" class="about py-5 bg-light">
        <div class="about-container container">
            <h2 class="section-heading mb-4 gsap-fade-up">About Us</h2>
            <p class="about-text">{{ config('app.name') }} (AAIS), established in 2005, is a leading educational
                ...
                offering a well-rounded education. With a strong emphasis on practical learning, knowledge, and building
                confidence, this sets us apart as a leading institution for excellence in education.</p>
            <p class="about-text">Located at No. 6 Oomnne Drive, Abayi, Aba, AAIS serves a diverse student body, offering a
                nurturing environment where every child can thrive. We emphasize practical learning, encouraging students to apply
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-4 gsap-fade-up">
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h4 class="my-0 font-weight-normal">Practical Learning</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4 gsap-fade-up">
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-info text-white">
                        <h4 class="my-0 font-weight-normal">Knowledge Empowerment</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4 gsap-fade-up">
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h4 class="my-0 font-weight-normal">Confidence Building</h4>
                    </div>
                    <div class="card-body">
    ...
    <section id="achievements" class="py-5">
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-3 gsap-fade-up">
                    <div class="card">
                        <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 gsap-fade-up">
                    ...
                    <p class="lead">Download our handbook for policies, schedules, and tips to support your child’s journey.
                    </p>
    ...
    <section id="enroll-now" class="py-5 text-center"
        ...
        <div class="container">
            ...
            <p class="lead gsap-fade-up">Give your child the gift of a world-class education. Enroll today and secure
                their future!</p>
            <a href="{{ route('admissions') }}" class="btn-secondary mt-3" style="color: #f5f5f5;">Enroll Now</a>
        </div>
    </section>
