...
def view_results(student_id):
    try:
        ...
        average = grand_total["total"] / non_zero_subjects if non_zero_subjects > 0 else 0
        average = round(average, 1)
...
def download_results_pdf(student_id):
    try:
        ...
        static_path = os.path.join(current_app.root_path, "static", "images", "MY_SCHOOL_LOGO.png")
